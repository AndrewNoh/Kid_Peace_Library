    ...
    function html5Upload() {	
    	...
    	sUploadURL= 'http://127.0.0.1/smarteditor/php_uploader/file_uploader_html5.php'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/smarteditor/php_uploader/file_uploader.php',	//샘플 URL입니다.
